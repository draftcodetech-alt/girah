  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8 py-12">
      ...
      <Link
        ...
        className="block bg-sage-light rounded-[var(--radius-surface)] p-6 mt-6 hover:bg-sage-light/70"
      >
        <h2 className="font-body text-card-title text-charcoal">Saved Shipping</h2>
        <p className="font-body text-small text-muted mt-2">Manage your saved delivery information</p>
      </Link>
